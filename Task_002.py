...
berry_num = list()
for i in range(num):
    num_berries = randint(0, 20) 
    berry_num.append(num_berries)
print(num, ' -> ', *berry_num)
total_berries = list()
for i in range(len(berry_num) - 1):
    total_berries.append(berry_num[i - 1] + berry_num[i] + berry_num[i + 1])
    total_berries.append(berry_num[-2] + berry_num[-1] + berry_num[0])
print(max(total_berries))
